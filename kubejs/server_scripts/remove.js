...
ServerEvents.recipes(event=>{
    const remove_id =[
        ...
        'gtceu:large_chemical_reactor/polydimethylsiloxane_from_elements',
        'gtceu:large_chemical_reactor/polydimethylsiloxane_from_silicon',
        'gtceu:chemical_reactor/polydimethylsiloxane_from_elements',
        'gtceu:chemical_reactor/polydimethylsiloxane_from_silicon',
        'gtceu:chemical_reactor/chloromethane_from_methanol',
        'gtceu:large_chemical_reactor/chloromethane_from_methanol',
        'gtceu:chemical_reactor/dimethylchlorosilane_from_chloromethane',
        'gtceu:large_chemical_reactor/dimethylchlorosilane_from_chloromethane',
        'gtceu:chemical_reactor/polydimethylsiloxane_from_dimethyldichlorosilane',
        'gtceu:large_chemical_reactor/polydimethylsiloxane_from_dimethyldichlorosilane',
        'gtceu:chemical_reactor/silicone_rubber',
        'gtceu:large_chemical_reactor/silicone_rubber',
        'gtceu:large_chemical_reactor/styrene_butadiene_rubber',
        'gtceu:chemical_reactor/styrene_butadiene_rubber',
        'gtceu:chemical_reactor/polybenzimidazole',
        'gtceu:large_chemical_reactor/polybenzimidazole',
        'gtceu:alloy_blast_smelter/tungsten_carbide',
        'gtceu:mixer/tungstencarbide',
        'gtceu:electric_blast_furnace/blast_tungsten_carbide',
        'gtceu:electric_blast_furnace/blast_tungsten_carbide_gas',
        'gtceu:alloy_blast_smelter/tungsten_carbide_gas',
        ...
        'gtceu:mixer/indium_gallium_phosphide',
        'gtceu:chemical_reactor/qbit_cpu_wafer_radon',
